...
<section class="hero" id="home">
    ...
    <?php if ($_SESSION['usertype'] == 'Employer') {?>
        <section class="container">
            ...
            <?php if ($_SESSION['workstation'] == 'Home') {?>
                <div class="profile-box mt-3" style ="background: #E32C27;">
            <?php }else if ($_SESSION['workstation'] == 'Office') { ?>
                <div class="profile-box mt-3" style ="background: #E32C27;">
            <?php }else if($_SESSION['workstation'] == 'Both') { ?>
                <div class="profile-box mt-3" style ="background: #E32C27;">
            <?php } ?> 
