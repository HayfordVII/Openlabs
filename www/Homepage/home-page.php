...
?>
	...
	<section class="carrer" id="carrer">
		...
		<div class="contai">
			<div class="card ">
			  <a href="CyberS.php"><img src="imgs/security-min.jpg" alt="" class="card__img"></a>
			  <div class="card__text">
				<a href="CyberS.php"><h3 class="card__title">CYBERSECURITY</h3></a>
			...
			<div class="card">
				<a href="Graphics.php"><img src="imgs/Graphics-min.jpg" alt="" class="card__img"></a>
				<div class="card__text">
                    <a href="Graphics.php"><h3 class="card__title">GRAPHIC DESIGN</h3></a>
		...
		<div class="contai">
			...
			<div class="card">
			  <a href="networking.php"><img src="imgs/Network-min.jpg" alt="" class="card__img"></a>
			  <div class="card__text">
				<a href="networking.php"><h3 class="card__title">NETWORKING</h3></a>
			  </div>	
			</div>

			<div class="card">
			  <a href="software.php"><img src="imgs/Software-min.jpg" alt="" class="card__img"></a>
			  <div class="card__text">
				<a href="software.php"><h3 class="card__title">SOFTWARE DEV</h3></a>	
			  </div>
			</div>

            
			<div class="card">
				<a href="webdev.php"><img src="imgs/Web Dev-min.jpg" alt="" class="card__img"></a>
				<div class="card__text">
                    <a href="webdev.php"><h3 class="card__title">WEB DEV</h3></a>
